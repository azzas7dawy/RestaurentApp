  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: Drawer(
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              title: const Text("Admin Orders", style: TextStyle(color: Colors.white)),
              onTap: () => Navigator.pushNamed(context, AdminOrdersScreen.id),
            ),
              ListTile(
              title: const Text("Statisics", style: TextStyle(color: Colors.white)),
            ...
            ListTile(
              ...
              onTap: () => Navigator.pushReplacementNamed(context, DashboardHomeScreen.id),
            ),
          ],
        ),
      ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildStatCard("Total Reservations", "$totalReservations", Icons.event_seat, Colors.teal),
            _buildStatCard("Today's Orders", "$todaysOrders ", Icons.shopping_cart, Colors.orange),
            const SizedBox(height: 20),
            const Text("Weekly Orders", style: TextStyle(color: Colors.white, fontSize: 18)),
            ...
            SizedBox(
              ...
              child: LineChart(LineChartData(
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: List.generate(7, (index) => FlSpot(index.toDouble(), (weeklyOrders.values.toList()[index]).toDouble())),
                    isCurved: true,
                    color: Colors.cyan,
                    barWidth: 3,
                    belowBarData: BarAreaData(show: true, color: Colors.cyan.withOpacity(0.3)),
                  ),
                ],
              )),
            )
