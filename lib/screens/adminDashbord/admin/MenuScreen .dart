...
import 'package:restrant_app/screens/adminDashbord/categoryItemScreenAdmin.dart';
...
class _AdminMenuScreenState extends State<AdminMenuScreen> {
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (newName.isNotEmpty && newName != oldName) {
                final oldDoc =
                    FirebaseFirestore.instance.collection('menu').doc(oldName);
                final newDoc =
                    FirebaseFirestore.instance.collection('menu').doc(newName);
  ...
  void _deleteCategory(String categoryId) async {
    ...
    if (confirm == true) {
      final docRef =
          FirebaseFirestore.instance.collection('menu').doc(categoryId);
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => AdminCategoryItemsScreen(
